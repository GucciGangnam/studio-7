    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ width: 6, height: 6, background: "#0a0a0a", borderRadius: 1 }} />
        </div>
        <span style={{
      ...
      <div style={{ display: "flex", gap: 8, marginLeft: "auto", alignItems: "center" }}>
        {[14, 14, 14].map((_, i) => (
          <div key={i} style={{ width: 14, height: 14, background: "#1e1e1e", borderRadius: 3 }} />
        ))}
      </div>
    </div>
  )
            ...
            <div className="mca-chart-bars">
              {CHART_BARS.map((h, i) => (
                <div key={i} className="mca-bar" style={{
                  height: `${h}%`,
                  background: h >= 88 ? "rgba(232,255,71,0.4)" : "#1e1e1e",
                }} />
              ))}
            </div>
          </div>
      ...
      <div style={{ position: "relative" }}>
        ...
        <AnimatePresence>
          {!isDesktop && (
            ...
            >
              <div style={{ position: "absolute", right: -3, top: 110, width: 3, height: 38, background: "#1e1e1e", borderRadius: "0 2px 2px 0" }} />
              <div style={{ position: "absolute", left: -3, top: 88,  width: 3, height: 26, background: "#1e1e1e", borderRadius: "2px 0 0 2px" }} />
              <div style={{ position: "absolute", left: -3, top: 122, width: 3, height: 26, background: "#1e1e1e", borderRadius: "2px 0 0 2px" }} />
              <div style={{ position: "absolute", left: -3, top: 62,  width: 3, height: 18, background: "#1e1e1e", borderRadius: "2px 0 0 2px" }} />
            </motion.div>
          )}
        </AnimatePresence>
  ...
  return (
    <div style={{ height: "100%", display: "flex", alignItems: "center", padding: "0 14px", position: "relative" }}>
      ...
      <div style={{ position: "absolute", left: "50%", transform: "translateX(-50%)" }}>
        <AnimatePresence mode="wait">
          <motion.span
            ...
            exit={{ opacity: 0, y: -4 }}
            transition={{ duration: 0.2 }}
            style={{ fontFamily: "Space Mono", fontSize: 10, color: "#555" }}
          >
      ...
      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 5 }}>
        ...
        <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#3a3a3a" }}>99.9%</span>
      </div>
    </div>
  )
}
      ...
      {nodes.map((node, i) => {
        ...
        return (
          <React.Fragment key={i}>
            {i > 0 && (
              <motion.div
                animate={{ background: isActive ? "rgba(232,255,71,0.3)" : "#1e1e1e" }}
            ...
            <motion.div
              animate={{
                borderColor: isCurrent
                  ...
                  : "#1e1e1e",
                backgroundColor: isCurrent ? "rgba(232,255,71,0.05)" : "#111",
              }}
              transition={{ duration: 0.3 }}
              style={{
                position: "absolute",
            ...
            >
              <span style={{ fontFamily: "Space Grotesk", fontSize: 12, fontWeight: 600, color: isActive ? "#bbb" : "#3a3a3a" }}>
                {node.label}
              </span>
              <span style={{
                fontFamily: "Space Mono", fontSize: 9, letterSpacing: "0.06em",
                color: isCurrent ? "#e8ff47" : isActive ? "#555" : "#222",
              }}>
                {node.sub}
              </span>
            </motion.div>
...
function BackendFlowDemo() {
  ...
  return (
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 28 }}>
      ...
      {/* Phase label */}
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <p style={{ fontFamily: "Space Mono", fontSize: 10, color: "#444", letterSpacing: "0.14em", textTransform: "uppercase", margin: 0 }}>
          Request lifecycle
        </p>
        <div style={{ width: 1, height: 10, background: "#2a2a2a" }} />
        <AnimatePresence mode="wait">
      ...
      <div style={{
        ...
        {/* Chrome bar */}
        <div style={{ height: 44, borderBottom: "1px solid #1e1e1e", position: "relative", zIndex: 1 }}>
...
function MetricCard({ label, value, delta, up, delay }: {
  ...
  return (
    <motion.div
      ...
      style={{ flex: 1, background: "#111", border: "1px solid #1e1e1e", borderRadius: 8, padding: "14px 16px" }}
    >
      <p style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444", letterSpacing: "0.12em", textTransform: "uppercase" as const, margin: "0 0 8px" }}>
        {label}
      </p>
      <p style={{ fontFamily: "Space Grotesk", fontSize: 22, fontWeight: 600, color: "#eee", margin: "0 0 6px", letterSpacing: "-0.02em" }}>
...
function LineChartPanel() {
  ...
  return (
    <motion.div
      ...
      style={{ background: "#111", border: "1px solid #1e1e1e", borderRadius: 8, padding: "16px 18px 14px" }}
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
        <p style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444", letterSpacing: "0.12em", textTransform: "uppercase" as const, margin: 0 }}>
      ...
      <svg width={W} height={H + 16} style={{ display: "block", overflow: "visible" }}>
        ...
        {[0.25, 0.5, 0.75].map(y => (
          <line key={y} x1={20} y1={y * H} x2={W - 20} y2={y * H} stroke="#1a1a1a" strokeWidth={1} />
        ))}
        <motion.path
        ...
        {MONTHS.map((m, i) => (
          <text key={i} x={20 + i * xStep} y={H + 14} textAnchor="middle"
            style={{ fontFamily: "Space Mono", fontSize: 9, fill: "#2a2a2a" }}>{m}</text>
        ))}
      </svg>
    </motion.div>
  )
...
function EventSourcesPanel() {
  return (
    <motion.div
      ...
      style={{ flex: 1, background: "#111", border: "1px solid #1e1e1e", borderRadius: 8, padding: "16px 18px" }}
    >
      <p style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444", letterSpacing: "0.12em", textTransform: "uppercase" as const, margin: "0 0 14px" }}>
        Events by Source
      </p>
        ...
        {EVENT_SOURCES.map((src, i) => (
          <div key={src.label}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#555" }}>{src.label}</span>
              <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#666" }}>{src.value.toLocaleString()}</span>
            </div>
        ...
        {FUNNEL_STEPS.map((step, i) => (
          <div key={step.label} style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 58, textAlign: "right" as const, flexShrink: 0 }}>
              <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444" }}>{step.label}</span>
            </div>
            <div style={{ flex: 1, height: 26, background: "#1a1a1a", borderRadius: 3, overflow: "hidden" }}>
              <motion.div
                initial={{ width: 0 }}
              ...
              >
                <motion.span
                  ...
                  style={{ fontFamily: "Space Mono", fontSize: 9, color: i === 3 ? "#000" : "#e8ff47", whiteSpace: "nowrap" as const }}
                >
                  {step.value}
                </motion.span>
              </motion.div>
            </div>
            <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#333", width: 26, textAlign: "right" as const }}>
              {step.pct}%
            </span>
          </div>
        ))}
...
function AnalyticsDashboardDemo() {
  ...
  return (
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
      ...
      {/* View label */}
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <p style={{ fontFamily: "Space Mono", fontSize: 10, color: "#444", letterSpacing: "0.14em", textTransform: "uppercase" as const, margin: 0 }}>
          Analytics
        </p>
        <div style={{ width: 1, height: 10, background: "#2a2a2a" }} />
        <AnimatePresence mode="wait">
      ...
      <div style={{
        ...
        {/* Chrome bar */}
        <div style={{
          height: 40, borderBottom: "1px solid #1e1e1e",
          ...
          <div style={{ display: "flex", gap: 4, marginLeft: 8 }}>
            {analyticsViews.map(v => (
              <button
                ...
                style={{
                  fontFamily: "Space Mono", fontSize: 9, letterSpacing: "0.06em",
                  color: view === v ? "#e8ff47" : "#333",
                  background: view === v ? "rgba(232,255,71,0.1)" : "transparent",
                  border: `1px solid ${view === v ? "rgba(232,255,71,0.25)" : "#1e1e1e"}`,
          ...
          <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 5 }}>
            ...
            />
            <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#333" }}>LIVE</span>
          </div>
        </div>
                ...
                <div style={{ display: "flex", gap: 14 }}>
                  ...
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
                    {[
                      ...
                      >
                        <span style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444", letterSpacing: "0.1em" }}>{s.label}</span>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <span style={{ fontFamily: "Space Grotesk", fontSize: 17, fontWeight: 600, color: "#ccc" }}>{s.value}</span>
            ...
            {view === "events" && (
              ...
              >
                ...
                <div style={{ marginBottom: 14 }}>
                  <p style={{ fontFamily: "Space Mono", fontSize: 9, color: "#444", letterSpacing: "0.12em", textTransform: "uppercase" as const, margin: "0 0 12px" }}>
                  ...
                  <div style={{ display: "flex", gap: 5, marginTop: 4 }}>
                    {DAILY_BARS.map((_, i) => (
                      <div key={i} style={{ flex: 1, textAlign: "center" as const }}>
                        <span style={{ fontFamily: "Space Mono", fontSize: 7, color: "#252525" }}>{i + 1}</span>
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                      {RETENTION_ROWS.map((row, ri) => (
                        <div key={ri} style={{ display: "flex", gap: 4 }}>
                          <span style={{ fontFamily: "Space Mono", fontSize: 8, color: "#2a2a2a", width: 28, flexShrink: 0, lineHeight: "18px" }}>
                            Wk {ri + 1}
                          </span>
                          {row.map((v, ci) => (
                            <motion.div key={ci}
                            ...
                            >
                              {v != null && (
                                <span style={{ fontFamily: "Space Mono", fontSize: 7, color: v === 100 ? "#000" : "#e8ff47" }}>
                                  {v}%
                                </span>
                              )}
                            </motion.div>
    ...
    <>
      ...
      {!loaded && (
        <div style={{
          ...
          fontFamily: "Space Mono", fontSize: 13, color: "#444", zIndex: 1,
        }}>
          loading frames…
        </div>
      )}
...
function SchemaCard({ table }: { table: SchemaTable }) {
  return (
    <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 6, overflow: "hidden", flex: 1, minWidth: 0 }}>
      <div style={{ padding: "7px 12px", borderBottom: "1px solid #161616", background: "#111" }}>
      ...
      {table.fields.map(f => (
        <div key={f.name} style={{ display: "flex", alignItems: "center", padding: "4px 12px", gap: 8 }}>
          ...
          <span style={{
            ...
            color: f.tag === "PK" ? "#aaa" : f.tag === "FK" ? "rgba(232,255,71,0.75)" : "#3a3a3a",
          }}>
            {f.name}
          </span>
          <span style={{ fontFamily: "Space Mono", fontSize: 7, color: "#222" }}>{f.type}</span>
        </div>
      ))}
    </div>
  )
    ...
    <div style={{ width: 220, minHeight: 268 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Layout size={11} color="#3a3a3a" />
        </div>
        <span style={{ fontFamily: "Space Grotesk", fontSize: 12, fontWeight: 600, color: "#2a2a2a" }}>
          your-app
        </span>
      </div>
          ...
          {items.map((item) => (
            ...
            >
              <div style={{
                ...
                <item.Icon size={13} color={item.isNew ? "#8a9820" : "#2e2e2e"} />
                <span style={{
                  fontFamily: "Space Grotesk", fontSize: 12, fontWeight: 500,
                  color: item.isNew ? "#8a9820" : "#2e2e2e",
                  flex: 1,
                }}>
                  {item.label}
                </span>
...
function DesignShowcase() {
  const palette = [
    { token: "background", hex: "#000000" },
    { token: "card",       hex: "#080808" },
    { token: "border",     hex: "#1a1a1a" },
    { token: "muted",      hex: "#444444" },
  ...
  return (
    <div style={{ maxWidth: 560, width: "100%", display: "flex", flexDirection: "column", gap: 26 }}>
      ...
      <div style={{ borderTop: "1px solid #0f0f0f", paddingTop: 22 }}>
        <motion.p
          initial={{ opacity: 0, x: -10 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          {[
            <p key="h" style={{ fontFamily: "Space Grotesk", fontSize: 30, fontWeight: 700, color: "#bbb", letterSpacing: "-0.02em", margin: 0, lineHeight: 1.1 }}>
              Precision by design
            </p>,
      ...
      {INTEGRATION_TILES.map(({ name, category, Icon }, i) => {
        ...
        return (
          <motion.div
            ...
            style={{
              background:  isCurrent ? "#131300" : "#0d0d0d",
              border:     `1px solid ${isCurrent ? "rgba(232,255,71,0.3)" : isConnected ? "rgba(232,255,71,0.08)" : "#1a1a1a"}`,
              borderRadius: 7,
              padding: "13px 14px", display: "flex", alignItems: "center", gap: 10,
              transition: "background 0.3s, border-color 0.3s",
            }}
          >
            <div style={{ flexShrink: 0, color: isCurrent ? "#e8ff47" : isConnected ? "#4a4a22" : "#2e2e2e", transition: "color 0.3s" }}>
              <Icon size={14} />
            </div>
            <div>
              <p style={{ fontFamily: "Space Grotesk", fontSize: 12, fontWeight: 600, color: isCurrent ? "#ccc" : isConnected ? "#4a4a4a" : "#3a3a3a", margin: "0 0 1px", transition: "color 0.3s" }}>{name}</p>
              <p style={{ fontFamily: "Space Mono", fontSize: 8, color: isCurrent ? "#666" : "#2a2a2a", margin: 0, letterSpacing: "0.04em", transition: "color 0.3s" }}>{category}</p>
            </div>
          </motion.div>
        )
      })}
      ...
      {SECURITY_LAYERS.map((layer, i) => (
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontFamily: "Space Mono", fontSize: 9, color: "#2e2e2e", margin: 0, letterSpacing: "0.04em" }}>
              {layer.sub}
            </p>
          </div>
